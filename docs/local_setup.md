...
本教程将从0开始构建一份能跑通本项目的docker容器化环境，适用于本地开发。
...
选择 Local_PC_Livox_MID_360 后会自动构建 docker 容器，构建完成后会自动进入容器终端。
...
```shell
git clone -b 4.2a8 https://github.com/borglab/gtsam.git
cd gtsam
